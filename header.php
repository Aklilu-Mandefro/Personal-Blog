...
<header>
		<div class="top-bar_sub_w3layouts container-fluid">
			<div class="row">
				<div class="col-md-4 logo text-left">
					<a class="navbar-brand" href="index.php">
						<i><img src="developer/dev2.jpg" height="40" width="40"></i> let us code</a>
				</div>
				<div class="col-md-4 top-forms text-center mt-lg-3 mt-md-1 mt-0">
					
					<span class="mx-lg-4 mx-md-2  mx-1">
						<a href="blogadmin/index.php">
							<i ></i> <strong>Sign In</strong></a>
					</span>
					<span>
						<a href="blogadmin/membership_signup.php">
							<i></i> <strong>Register</strong></a>
					</span>
				</div>
			...
			<div class="top-bar_sub_w3layouts container-fluid">
				...
				<div class="col-md-11.5 top-forms text-center mt-lg-10 mt-md-1 mt-0">
					<span align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="green">Small Group of Thoughful Committed Citizen Can Change the World!</font></span>
				</div>
